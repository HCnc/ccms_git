...
def param_talker():
    ...
    #rospy.loginfo(type(global_example))
    #rospy.loginfo("%s is %s", rospy.resolve_name('/global_example'), global_example)
    rospy.set_param("/global_example", [[[5],[1]],[[2],[3]]])
    a=rospy.get_param("/global_example")
    a[0][1]=[8]
    #rospy.loginfo(a)
    rospy.set_param("/global_example", a)
    b=rospy.get_param("/global_example")
    rospy.loginfo(b)
    rospy.loginfo(type(b))
